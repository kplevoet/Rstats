...
knitr::include_graphics("Class2_Functions.png")
```

## Class 2: Functions in R

- Chapter 5: **Functions**
    - 5.1: **Arguments**
    - 5.2: **Body**
    - 5.3: **Environments**
    - 5.4: **Binary operators** (TODO: move to Class3?)
    - 5.5: **Replacement functions** (TODO: move to Class3?)
...
TODO: next to return values, there is also:
...
- E.g. modify the object definition in Class 1: objects are bindings of names to values of a certain type **within a specific environment**.
...
- This last property is called **reference semantics** (see Class _6_).
...
- In Class 1 we saw that values can be **assigned** to the outcome of certain functions (or operators):
