---
title: "Class 7: Writing reproducible reports in R"
...
knitr::include_graphics("Class7_Reporting.png")
```

## Class 7: Writing reproducible reports in R

- Chapter 16: **Writing reproducible reports in R**
...
- This class covers the **rmarkdown** package which automatically loads the **knitr** package.
